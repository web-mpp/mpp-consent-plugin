...
$translations = [
	'en_US' => [ 'label' => 'English (US)', 'flag' => '🇺🇸',
		...
		'modal_policy_link' => 'Read our Cookie Policy', 'modal_accept' => 'Accept All', 'modal_close' => 'Close', 'modal_save' => 'Save and Close',
	...
	'fr_FR' => [ 'label' => 'Français (France)', 'flag' => '🇫🇷',
		...
		'modal_policy_link' => 'Lire notre politique de cookies', 'modal_accept' => 'Tout accepter', 'modal_close' => 'Fermer', 'modal_save' => 'Enregistrer et fermer',
	...
	'de_DE' => [ 'label' => 'Deutsch', 'flag' => '🇩🇪',
		...
		'modal_policy_link' => 'Cookie-Richtlinie lesen', 'modal_accept' => 'Alle akzeptieren', 'modal_close' => 'Schließen', 'modal_save' => 'Speichern und schließen',
	...
	'es_ES' => [ 'label' => 'Español', 'flag' => '🇪🇸',
		...
		'modal_policy_link' => 'Leer nuestra política de cookies', 'modal_accept' => 'Aceptar todo', 'modal_close' => 'Cerrar', 'modal_save' => 'Guardar y cerrar',
	...
	'it_IT' => [ 'label' => 'Italiano', 'flag' => '🇮🇹',
		...
		'modal_policy_link' => 'Leggi la nostra informativa sui cookie', 'modal_accept' => 'Accetta tutto', 'modal_close' => 'Chiudi', 'modal_save' => 'Salva e chiudi',
	...
	'nl_NL' => [ 'label' => 'Nederlands', 'flag' => '🇳🇱',
		...
		'modal_policy_link' => 'Lees ons cookiebeleid', 'modal_accept' => 'Alles accepteren', 'modal_close' => 'Sluiten', 'modal_save' => 'Opslaan en sluiten',
	...
	'pt_PT' => [ 'label' => 'Português', 'flag' => '🇵🇹',
		...
		'modal_policy_link' => 'Ler a nossa política de cookies', 'modal_accept' => 'Aceitar tudo', 'modal_close' => 'Fechar', 'modal_save' => 'Guardar e fechar',
	...
	'pt_BR' => [ 'label' => 'Português (BR)', 'flag' => '🇧🇷',
		...
		'modal_policy_link' => 'Leia nossa política de cookies', 'modal_accept' => 'Aceitar tudo', 'modal_close' => 'Fechar', 'modal_save' => 'Salvar e fechar',
		'cat_essential_label' => 'Essencial', 'cat_essential_description' => 'Os cookies essenciais são necessários para o correto funcionamento do site e não podem ser desativados.',
	...
	'pl_PL' => [ 'label' => 'Polski', 'flag' => '🇵🇱',
		...
		'modal_policy_link' => 'Przeczytaj naszą politykę cookies', 'modal_accept' => 'Akceptuj wszystkie', 'modal_close' => 'Zamknij', 'modal_save' => 'Zapisz i zamknij',
	...
	'sv_SE' => [ 'label' => 'Svenska', 'flag' => '🇸🇪',
		...
		'modal_policy_link' => 'Läs vår cookiepolicy', 'modal_accept' => 'Acceptera alla', 'modal_close' => 'Stäng', 'modal_save' => 'Spara och stäng',
	...
	'da_DK' => [ 'label' => 'Dansk', 'flag' => '🇩🇰',
		...
		'modal_policy_link' => 'Læs vores cookiepolitik', 'modal_accept' => 'Accepter alle', 'modal_close' => 'Luk', 'modal_save' => 'Gem og luk',
...
$string_labels = [
	...
	'modal_policy_link' => [ __( 'Cookie Policy Link',  'wp-cookie-shield' ), false, 'modal'   ],
